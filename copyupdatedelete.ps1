...
$allowedDirs = @(
    ...
    "apps\dashboard\src\lib\apollo.client.ts",
    "apps\dashboard\src\hooks\client.providers.tsx",
    "apps\dashboard\src\graphql\generated\graphql.ts",
    "apps\dashboard\src\components\DashboardNotificationWrapper.tsx",
    ...
    "apps\bot\src\graphql\generated\graphql.ts",
    "apps\bot\src\events\handle.create.category.ts",
    "apps\bot\src\events\handle.update.category.ts",
    "apps\bot\src\common\bot.apollo.client.ts",
